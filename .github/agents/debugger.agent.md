---
description: An agent to help debug code by providing detailed error analysis and potential fixes. Use when encountering bugs, errors, or unexpected behavior.
...
- Confirm: Inputs are correct, functions return expected data, variables hold expected values.

## Use Tools
- Use built-in debuggers (e.g., `pdb`, Chrome DevTools, VS Code debugger).
