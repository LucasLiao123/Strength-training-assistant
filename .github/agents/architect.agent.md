---
description: An agent for architects to design and plan software systems, including defining components, interactions, and technologies. Use when planning new modules, reviewing system design, or discussing architecture decisions.
tools: ['codebase']
---
